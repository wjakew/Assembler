...
cmp $0, %eax #sprawdzam pierwszy warunek
jne set1_2
mov $0,%eax #jesli sie zgadza zapisuje -1 w rejestrze i przechodze dalej
jmp _exit2
...
set2_2:
	...
	push %rax
	call fib # w %eax mam wartosc funkcji dla parametru n-2
	add $8, %rsp

	add %edx,%eax #dodajemy wartosc dla wywolania n-1 z wartoscia dla n-2
