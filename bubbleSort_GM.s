...
bubbleSort:
	...
	mov 	%r8, %rcx		# przepisuje ilosc liczb do %rcx (ilosc obrotow petli)
	...
	_loop1_bs:
		...
		_loop2_bs:
			movl	(%rsi), %eax	# przesuwam aktualna wartosc z tabeli numbers do %rax
			cmp 	4(%rsi), %eax	# porownuje NASTEPNA WARTOSC Z AKTUALNA WARTOSCIA TABELI
			jbe 	_inc_loop2_bs	# skoro kolejna bedzie wieksza od aktualnej nalezy je zamienic miejscami

			xchg 	4(%rsi), %eax	# zamieniam miejscami liczby
			movl 	%eax, (%rsi)
